...
<div class="hero">
  ...
  <p>面向 Kubernetes 与云原生基础设施管理的生产级 MCP 服务器，聚合 13 个服务与 292 个工具，支持 SSE / Streamable-HTTP 两种运行模式。</p>
...
<div class="usecase-grid">
  ...
  <article class="usecase-card">
    <h3>可观测性协同分析</h3>
    <p>跨 Prometheus、Grafana、Loki、Jaeger、Langfuse、Sentry、OpenTelemetry 联动，串联指标、日志与链路数据。</p>
  </article>
</div>
...
<div class="service-grid">
  ...
  <div class="service-card">
    <h3>Grafana <span class="tool-count">51 工具</span></h3>
    <p>仪表盘、可视化与告警配置管理。</p>
  </div>
  <div class="service-card">
