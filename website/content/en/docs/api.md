...
Common service names include `kubernetes`, `helm`, `grafana`, `prometheus`, `loki`, `kibana`, `elasticsearch`, `alertmanager`, `jaeger`, `langfuse`, `opentelemetry`, `utilities`, and `aggregate`.
