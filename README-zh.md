...
一个高性能的模型上下文协议（MCP）服务器，用于 Kubernetes 和云原生基础设施管理，集成了 12 个服务和 275 个工具。
...
- **多服务集成**: Kubernetes、Grafana、Prometheus、Loki、Kibana、Elasticsearch、Helm、Alertmanager、Jaeger、Langfuse、OpenTelemetry、Utilities
