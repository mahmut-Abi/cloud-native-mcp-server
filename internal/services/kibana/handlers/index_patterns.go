...
func HandleGetIndexPattern(c *client.Client) func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		indexPatternID, err := requireStringParam(req, "index_pattern_id")
		if err != nil {
			return &mcp.CallToolResult{
				IsError: true,
				Content: []mcp.Content{
...
func HandleCreateIndexPattern(c *client.Client) func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		customSource, err := getOptionalObjectParam(req, "customSource")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
		fieldFormatMap, err := getOptionalObjectParam(req, "fieldFormatMap")
		if err != nil {
			return mcp.NewToolResultError(err.Error()), nil
		}
		...
		pattern, err := c.CreateIndexPattern(ctx, title, timeField, customSource, fieldFormatMap)
		if err != nil {
			return &mcp.CallToolResult{
				IsError: true,
				Content: []mcp.Content{
...
func HandleUpdateIndexPattern(c *client.Client) func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, req mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		pattern, err := c.UpdateIndexPattern(ctx, patternID, title, timeField, fieldFormatMap)
		if err != nil {
			return &mcp.CallToolResult{
				IsError: true,
				Content: []mcp.Content{
